...
<html>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href='./Order' class='visiting'>Basket</a></li>
        </ul>
    </header>
        <div class="flex-container">
            <h1>Order the below items</h1>
            <br/>
        </div>
        <div class="flex-container">
        ...
        <form action='/asst3/Purchase' onsubmit='return validate(this)' class="flex-container" method='post' style="margin-bottom: 15vh;">
